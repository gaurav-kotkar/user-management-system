...
# Start JSON Server (uses db.json)
...
For the test task submission:

1. **GitHub Repository**: Push code to public repo
2. **Live Deployment**: Deploy to Vercel/Netlify
3. **Email**: Send both URLs to dsvreact@gmail.com

Subject: `React CRUD Test Task Submission - Gaurav Ulhas Kotkar`
...
- Review `src/config/formSchema.ts` for field examples
